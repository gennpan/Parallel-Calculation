 ...
 *
 * versione 3 con dynamic, con definita una costante, se sostiutuissimo
 * con static probabilmente andrebbe leggermente più veloce
 * perchè comunque si perde tempo a riordinare le iterazioni. 
 * */
